...
/**
 * Küçük, bağımlılıksız Feather-stili ikon seti.
 * 3K Kampüs "2026 modern" sayfalarında kullanılan inline SVG ikon diliyle
 * (stroke="currentColor", strokeWidth=2, viewBox 0 0 24 24) tutarlıdır.
 */

...
class AttendanceIzinOverrideTest(TestCase):
    ...
    def test_manual_excused_without_izin_record_is_kept(self):
        """Yoklamada İzinli seçilince resmi izin kaydı olmasa da Yok yazılmamalı."""
        ...
        self.assertFalse(self.record.izinli_mi)

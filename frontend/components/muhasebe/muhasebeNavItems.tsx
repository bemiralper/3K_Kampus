...
export const MUHASEBE_FINANS_CHILDREN: MuhasebeNavChildDef[] = [
  ...
  {
    id: "virman",
    href: `${MUHASEBE_FINANS_BASE}/virman`,
    label: "Virman",
    matchPrefix: `${MUHASEBE_FINANS_BASE}/virman`,
  },
  {
  ...
  {
    id: "gelir-v2",
    href: `${MUHASEBE_FINANS_BASE}/gelir-v2`,
    label: "Gelir İşlemleri",
    matchPrefix: `${MUHASEBE_FINANS_BASE}/gelir-v2`,
  },
  {
    id: "gider-v2",
    href: `${MUHASEBE_FINANS_BASE}/gider-v2`,
    label: "Gider İşlemleri",
    matchPrefix: `${MUHASEBE_FINANS_BASE}/gider-v2`,
  },
  {
    id: "cari-hesaplar-v2",
    href: `${MUHASEBE_FINANS_BASE}/cari-hesaplar-v2`,
    label: "Cari Hesaplar",
    matchPrefix: `${MUHASEBE_FINANS_BASE}/cari-hesaplar-v2`,
  },
  {
    id: "cek-senet",
    href: `${MUHASEBE_FINANS_BASE}/cek-senet-v2`,
    label: "Çek / Senet",
    matchPrefix: `${MUHASEBE_FINANS_BASE}/cek-senet`,
  },
  {
    id: "gelir-gider-v2-tanimlar",
    href: `${MUHASEBE_FINANS_BASE}/gelir-gider-v2/tanimlar`,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/muhasebe/iletisim/sablonlar",
        label: "Şablonlar",

...
from apps.ozel_ders.services.pdf_brand import (
    BRAND, BRAND_DARK, INK, LINE, MUTED, _logo_path, register_fonts,
)
...
def _safe_filename(name: str) -> str:
    from apps.coaching.application.olcme_karne_pdf import _safe_filename as _karne_safe

    return _karne_safe(name)

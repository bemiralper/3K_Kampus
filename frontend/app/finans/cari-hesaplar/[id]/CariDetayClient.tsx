...
import { useOdemeYontemleriForMaliHesap, usePlanOdemeYontemleri } from "../../hooks/useOdemeYontemleriForMaliHesap";
...
export default function CariDetayClient({
  ...
  const odemeYontemleriList = usePlanOdemeYontemleri(kurumId, activeSube?.id);
  ...
  const gelirOdemeYontemleri = useOdemeYontemleriForMaliHesap(
    kurumId,
    gelirForm.mali_hesap_id ?? null,
    activeSube?.id,
  );
  const gelirTahsilatOdemeYontemleri = useOdemeYontemleriForMaliHesap(
    kurumId,
    gelirTahsilatForm.mali_hesap_id || null,
    activeSube?.id,
  );
  ...
  return (
    <div className="section">
      ...
      <TahsilatDrawer
        ...
        odemeYontemleri={gelirTahsilatOdemeYontemleri}
        maliHesaplar={gelirMaliHesaplar}
      />
...
function OdemeYapDrawer({
  ...
  const filtreliOdemeYontemleri = useOdemeYontemleriForMaliHesap(
    kurumId,
  ...
  const selectedYontem = filtreliOdemeYontemleri.find((o) => o.id === form.odeme_yontemi_id);

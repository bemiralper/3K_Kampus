...
export const TEMPLATE_VARIABLES = [
  ...
  { key: "sabah_ilk_etut_saati", label: "Sabah ilk etüt giriş saati", token: "{{sabah_ilk_etut_saati}}", group: "yoklama" },
  { key: "ogle_ilk_etut_saati", label: "Öğleden sonra ilk etüt giriş saati", token: "{{ogle_ilk_etut_saati}}", group: "yoklama" },
  { key: "aksam_ilk_etut_saati", label: "Akşam ilk etüt giriş saati", token: "{{aksam_ilk_etut_saati}}", group: "yoklama" },

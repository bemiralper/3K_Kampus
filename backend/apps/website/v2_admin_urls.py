...
urlpatterns = [
    ...
    path('content/<int:pk>/cover/', v2.api_v2_content_cover, name='content_cover'),
    path('content/<int:pk>/gallery/', v2.api_v2_content_gallery, name='content_gallery'),
    path('content/<int:pk>/gallery/<str:item_id>/', v2.api_v2_content_gallery_item, name='content_gallery_item'),
    path('content/<int:pk>/attachments/', v2.api_v2_content_attachment, name='content_attachment'),
    path('content/<int:pk>/attachments/<str:item_id>/', v2.api_v2_content_attachment_item, name='content_attachment_item'),

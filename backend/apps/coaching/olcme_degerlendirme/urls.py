...
from .views.karne_views import (
    ...
    exam_karne_notify_bulk_progress,
...
urlpatterns = [
    ...
    path('exams/<int:exam_pk>/results/students/<int:answer_pk>/suggestions/', suggest_students, name='student-suggest'),
    ...
    path('exams/<int:exam_pk>/analysis/students/notify-bulk-progress/', exam_karne_notify_bulk_progress, name='analysis-karne-notify-bulk-progress'),

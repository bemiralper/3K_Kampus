...
def serialize_site_settings(settings, request):
    ...
    return {
        ...
        'ticari_unvan': getattr(settings, 'ticari_unvan', '') or '',
        'mersis_no': getattr(settings, 'mersis_no', '') or '',
        'vergi_no': getattr(settings, 'vergi_no', '') or '',
        'ticaret_sicil_no': getattr(settings, 'ticaret_sicil_no', '') or '',
